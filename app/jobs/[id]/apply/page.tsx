...
export default function ApplyJob() {
  const { id } = useParams() as { id: string }; // ✅ FIX: Use useParams()
  ...
  return (
    <div className="mx-auto max-w-2xl p-6 bg-[#171923] rounded-lg">
          ...
          <Form className="space-y-6">
            <div>
              ...
              <ErrorMessage
                name="name"
                component="div"
                className="mt-1 text-sm text-[#e53e3e]"
              />
            </div>
            <div>
            ...
            <Button
              ...
              className="w-full bg-[#38A169] text-white hover:bg-[#2F855A]"
            >
